            ...
            <div class="row">
                <div class="col-md-5 mb-4 mb-md-0">
                    ...
                    <div class="product-image-slider">
                        ...
                        <div data-image="images/showcase/showcase-1.png">
                            <img class="img-fluid w-100" src="images/showcase/showcase-1.png" alt="product-image">
                        </div>
                ...
                <div class="col-lg-6 col-md-7 offset-lg-1">
                    ...
                    <button class="snipcart-add-item btn btn-main mb-5" data-item-id="apple-watch__25.00"
                        data-item-name="Apple Watch" data-item-image="images/showcase/showcase-1.png"
                        data-item-price="25.00" data-item-url="products/product-1/" data-item-custom1-name="Choose Color"
